...
- **[triagent](https://github.com/chinmayrozekar/triagent)** — Agentic RAG-based log triage system for semiconductor debug workflows. Built with FAISS, Drain3, Ollama, and local LLMs. Designed to cut down the time engineers spend chasing failures across post-silicon logs.
